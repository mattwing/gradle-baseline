...
| `com.palantir.baseline-prefer-project-modules` | Configures the default resolution strategy to [prefer project modules](https://docs.gradle.org/current/javadoc/org/gradle/api/artifacts/ResolutionStrategy.html#preferProjectModules--).
